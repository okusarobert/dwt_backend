#!/usr/bin/env python3
"""
Test script for LTC daemon with authentication
"""
...
class LTCAuthTester:
    ...
    async def run_all_tests(self):
        """Run all LTC connection tests with authentication"""
        print("🚀 Starting LTC Daemon Connection Tests (with Auth)")
        print("=" * 60)
        ...
        # Print summary
        print("\n" + "=" * 60)
        print("📊 LTC CONNECTION TEST SUMMARY (with Auth)")
        print("=" * 60)
